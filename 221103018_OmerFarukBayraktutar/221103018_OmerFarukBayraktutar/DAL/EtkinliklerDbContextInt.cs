...
{
    // IdentityDbContext<AppUser> yerine IdentityDbContext<AppUser, IdentityRole<int>, int> kullanarak int ID belirtiyoruz
    public class EtkinliklerDbContextInt : IdentityDbContext<AppUser, IdentityRole<int>, int>
    {
        public EtkinliklerDbContextInt(DbContextOptions<EtkinliklerDbContextInt> options) : base(options)
        {
        }
