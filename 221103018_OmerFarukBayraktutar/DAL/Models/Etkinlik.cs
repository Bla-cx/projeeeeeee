...
namespace _221103018_OmerFarukBayraktutar.DAL.Models
{
    public class Etkinlik
    {
        ...
        [ForeignKey("SehirId")]
        public Sehir? Sehir { get; set; }        [Required(ErrorMessage = "Adres zorunludur.")]        [StringLength(500, ErrorMessage = "Adres en fazla 500 karakter olabilir.")]
        public string Adres { get; set; } = string.Empty;        [StringLength(255)]        public string? ResimYolu { get; set; }        
        ...
        [Required(ErrorMessage = "Toplam kapasite zorunludur.")]
        [Range(1, int.MaxValue, ErrorMessage = "Toplam kapasite en az 1 olmalıdır.")]
        public int ToplamKapasite { get; set; }

        [Required(ErrorMessage = "Kalan kapasite zorunludur.")]
        [Range(0, int.MaxValue, ErrorMessage = "Kalan kapasite negatif olamaz.")]
